...
private void setupCalculatorPanel() {
    ...
    openPriceField.setHorizontalAlignment(SwingConstants.RIGHT); // 文本右对齐
    ...
    closePriceField.setHorizontalAlignment(SwingConstants.RIGHT); // 文本右对齐
    ...
    quantityField.setHorizontalAlignment(SwingConstants.RIGHT); // 文本右对齐
...
// 为输入字段添加文档监听器，用于检查输入是否有效
        DocumentListener inputListener = new DocumentListener() {
            ...
            private void updateButtonColor() { // 私有方法，用于更新按钮颜色
